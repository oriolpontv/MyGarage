...
namespace MyGarage
{
    public partial class EliminarClient : Form

    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sqlCmd.CommandText = "DELETE FROM CLIENTS WHERE id_client = " + this.textBox1.Text;
                sqlRd = sqlCmd.ExecuteReader();
                sqlDt.Load(sqlRd);
                sqlRd.Close();
                sqlCon.Close();
                MessageBox.Show("Client eliminat correctament!");
                this.textBox1.Clear();
                this.Close();
            }
        }
